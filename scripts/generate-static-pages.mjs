...
const PAGE_DEFINITIONS = [
  ...
  },
  {
    ...
    description: 'Read the WILDS AURA privacy policy covering contact form data, comments, community data, analytics, and future Instagram or Facebook connector data.',
    heading: 'Privacy Policy',
    body: 'Wildsaura privacy practices for contact messages, comments, community posts, analytics, and future Instagram or Facebook connector data.',
