...
index 79e4857109c288377363a3b608d91cb34d996d37..6e212a249d03686654dc53543691071a5256f028 100644
...
+            }}
+          >
+            <div className="section-subtitle" style={{ marginBottom: '0.45rem', color: '#f0fff4', fontWeight: 700 }}>
...
+            <a href="/marketplace" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', textDecoration: 'none' }} className="text-wa-muted">
