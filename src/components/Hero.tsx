...
<<<<<<< codex/redesign-layout-for-professional-look-m8xcqb
          ...
          >
            <p className="section-subtitle" style={{ marginBottom: '0.45rem', color: '#f0fff4', fontWeight: 700 }}>
...
>>>>>>> main
          ...
          <div className="animate-fade-in-up anim-delay-600" style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            ...
            <a href="/marketplace" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', textDecoration: 'none' }} className="text-wa-muted">
              ...
              <span className="font-cinzel" style={{ fontSize: '0.7rem', letterSpacing: '0.15em' }}>
                Visit Marketplace
              </span>
            </a>
