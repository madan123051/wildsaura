  ...
  return (
    <header
      style={{
        ...
        transition: 'all 0.5s',
        background: scrolled ? 'rgba(12, 15, 14, 0.92)' : 'rgba(12, 15, 14, 0.48)',
        backdropFilter: 'blur(12px)',
        borderBottom: scrolled ? '1px solid rgba(255,217,183,0.2)' : '1px solid transparent',
    ...
    >
        ...
        <a href="#top" style={{ display: 'flex', alignItems: 'center', gap: '0.85rem', textDecoration: 'none' }}>
          {logoUrl && (
            <img
              ...
              style={{ height: 52, width: 'auto', objectFit: 'contain', filter: 'drop-shadow(0 0 10px rgba(226,75,45,0.4))' }}
            />
          )}
          <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1.3 }}>
            <span className="font-cinzel" style={{
              fontWeight: 700, letterSpacing: '0.2em', fontSize: '1.15rem',
              background: 'linear-gradient(135deg, #ff8a63 0%, #ffd9b7 50%, #e24b2d 100%)',
            ...
            <span style={{
              ...
              color: 'rgba(255, 217, 183, 0.85)', fontWeight: 400,
            }}>
              Photography
            </span>
          </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          {isAdmin && onAdminClick && (
            <button
              ...
              style={{
                background: 'linear-gradient(135deg, rgba(226,75,45,0.32), rgba(226,75,45,0.12))',
                border: '1px solid rgba(255,217,183,0.42)',
                cursor: 'pointer',
                color: 'var(--wa-gold)',
                padding: '0.35rem',
                borderRadius: '8px',
              ...
              onMouseOver={(e) => { e.currentTarget.style.background = 'rgba(226,75,45,0.28)'; e.currentTarget.style.boxShadow = '0 0 14px rgba(226,75,45,0.35)'; }}
              onMouseOut={(e) => { e.currentTarget.style.background = 'linear-gradient(135deg, rgba(226,75,45,0.32), rgba(226,75,45,0.12))'; e.currentTarget.style.boxShadow = 'none'; }}
            >
              <Settings size={20} />
            </button>
          )}
      ...
      {menuOpen && (
        <div style={{
          background: 'rgba(16, 14, 12, 0.95)', backdropFilter: 'blur(16px)',
          borderTop: '1px solid rgba(255,217,183,0.22)',
          padding: '1.5rem 2rem',
          ...
          <div style={{ maxWidth: '600px', margin: '0 auto' }}>
            ...
            {navItems.map((item) => (
              <a
                ...
                style={{
                  ...
                  borderBottom: '1px solid rgba(255,217,183,0.2)',
            ...
            {/* Visitor area */}
            <div style={{ marginTop: '0.75rem', paddingTop: '0.75rem', borderTop: '1px solid rgba(255,217,183,0.22)' }}>
              {visitor ? (
                <div style={{ padding: '0.5rem 0' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
                    ...
                    <div
                      style={{
                        ...
                        background: getAvatarEmoji() ? 'rgba(226,75,45,0.22)' : visitor.avatarColor,
                        display: 'flex', alignItems: 'center', justifyContent: 'center',
                        fontSize: getAvatarEmoji() ? '1.5rem' : '1rem',
                        fontWeight: 700, color: getAvatarEmoji() ? undefined : '#000',
                        border: '2px solid rgba(255,217,183,0.55)',
                        flexShrink: 0,
                      }}
                    >
                      ...
                      {editingName ? (
                        <div style={{ display: 'flex', gap: '0.3rem', alignItems: 'center' }}>
                          <input
                            ...
                            autoFocus
                            style={{
                              background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,217,183,0.42)',
                  ...
                  <button
                    ...
                    style={{
                      ...
                      background: showAvatarPicker ? 'rgba(226,75,45,0.22)' : 'rgba(226,75,45,0.12)',
                      border: '1px solid rgba(255,217,183,0.32)', borderRadius: '10px',
                  ...
                  {showAvatarPicker && (
                    <div
                      ...
                      style={{
                        ...
                        background: 'rgba(226,75,45,0.12)', borderRadius: '12px',
                        border: '1px solid rgba(255,217,183,0.32)',
                      }}
                    >
                          ...
                          return (
                            <button
                              ...
                              style={{
                                ...
                                background: isSelected ? 'rgba(226,75,45,0.28)' : 'rgba(255,255,255,0.04)',
