...
import { X, Heart, Share2, Download, MapPin, User, Tag, Camera, Maximize2, Timer, Zap, Eye, Lock, ImageOff } from 'lucide-react';
...
export const PhotoModal: React.FC<PhotoModalProps> = ({
  photo, onClose, onLike, onShare, onDownload, visitor, comments, onAddComment, onVisitorLoginClick, freeDownloadsLeft, isDownloading,
}) => {
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: '0.5rem' }}>
            <div style={{ flex: 1, paddingRight: '1rem' }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '0.75rem', fontSize: '0.7rem' }} className="text-wa-muted">
                ...
                {photo.location && <span style={{ display: 'flex', alignItems: 'center', gap: '0.25rem' }}><MapPin size={11} /> {photo.location}</span>}
          ...
          {activeTab === 'info' && (
            <div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
                ...
                {photo.location && <InfoCard label="Location" value={photo.location} icon={<MapPin size={14} style={{ color: 'var(--wa-gold)' }} />} />}
